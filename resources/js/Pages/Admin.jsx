                                ...
                                <div className="card-body">
                                    <div className="support-ticket media pb-1 mb-3">
                                        ...
                                        <div className="media-body ml-3">
                                            ...
                                            <p className="my-1">
                                                Hi, can you please add new table
                                                for advan...
                                            </p>
                                    ...
                                    <div className="support-ticket media pb-1 mb-3">
                                        ...
                                        <div className="media-body ml-3">
                                            ...
                                            <p className="my-1">
                                                please check select item in
                                                advance form not work...
                                            </p>
                                            <small className="text-muted">
                                                Created by{" "}
                                                <span className="font-weight-bold font-13">
                                    ...
                                    <div className="support-ticket media pb-1 mb-3">
                                        ...
                                        <div className="media-body ml-3">
                                            ...
                                            <a href="javascript:void(0)">
                                                Are you provide template in
                                                Angular?
                                            </a>
                                            <p className="my-1">
                                                can you provide template in
                                                latest angular 8.
                                            </p>
                                            <small className="text-muted">
                                                Created by{" "}
                                    ...
                                    <div className="support-ticket media pb-1 mb-3">
                                        ...
                                        <div className="media-body ml-3">
                                            ...
                                            <p className="my-1">
                                                Hi, John, can you work on
                                                increase page speed of
                                                template...
                                            </p>
                                            <small className="text-muted">
                                                Created by{" "}
